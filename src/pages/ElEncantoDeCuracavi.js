...
import imageGaleria1 from "../image/elEncantoDeCuracavi/carruselElEncantoDeCuracavi.jpg";
...
const ElEncantoDeCuracavi = () => {
  return (
    <div>
      <Navbar />
      <div className="conteinerParcelaElEncanto">
...
export default ElEncantoDeCuracavi;
